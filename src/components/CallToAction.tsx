  ...
  return (
    <section className="bolt-section">
      <div className="max-w-5xl mx-auto text-center">
        <div className="bg-gray-50 rounded-3xl p-12 relative overflow-hidden shadow-xl">
          {/* Decorative elements */}
          <div className="absolute -top-24 -right-24 w-48 h-48 rounded-full bg-gray-200/50 blur-3xl"></div>
          <div className="absolute -bottom-24 -left-24 w-48 h-48 rounded-full bg-gray-200/50 blur-3xl"></div>
